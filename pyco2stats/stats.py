...
class Stats:
    ...
    def mad_std(data, axis=None, func=None, ignore_nan=False):
        ...
        is the normal inverse cumulative distribution function evaluated at probability P = 3/4.
    ...
    def umvue_sichel_lognormal_estimator(X_lognorm_data):
        ...
        but it is based on the computation of the hypergeometric function. THe formulation is:
    ...
    def finneys_g(m, z, n_terms_inc=10, max_iter=100, tol=1e-10):
        ...
        .. math::
            ...
            g_{m}(z) = 1 + \sum_{i = 1}^{\infty}\frac{m^{2i-1}z^{i}}{i!(m+1)^{i}\prod_{j=1}^{i-1}(m+2j)}
    ...
    def ci_standard_approx(
        ...
        .. math::
            ...
            \left[\theta-t_{1-\alpha/2}\hat\sigma_{\theta} ; \theta+t_{1-\alpha/2}\hat\sigma_{\theta}\right]
